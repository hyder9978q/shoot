...
/// متحكم الوضع الليلي — يبدّل اللوحة وينبّه [isDark] فوراً.
///
/// [isDark] هو ValueNotifier عادي — أي شاشة تحتاج تتحدث فوراً (تُعرض
/// حالياً وتحتوي مفتاح التبديل نفسه، مثل شاشة الإعدادات وتبويب حسابي)
/// تسمعه مباشرة عبر [ValueListenableBuilder] بمكانها، بدل إعادة بناء
/// MaterialApp كامل من جذره (كان يفقد كومة التنقل ويرجّع للسبلاش).
///
